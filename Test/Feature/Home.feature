...
Background:
And I Launch the browser to access the OpenWeather URL 
...
When I enter the city name as Test
...
When I enter the city name as Mumbai
Then after clicking on Search,  Mumbai, IN should be displayed
And I should be able to see the description as  shower rain
